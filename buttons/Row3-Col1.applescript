-- buttons/Row3-Col1.applescript
-- Thin wrapper: downloads and runs scripts/Row3-Col1.applescript from GitHub.
-- Assign this (compiled as .app) to Stream Deck button at row 3, column 1.
-- To change what this button does, edit scripts/Row3-Col1.applescript in the repo.

set scriptName to "Row3-Col1.applescript"
...
on error
	say "Button " & "3" & " " & "1" & " not available. No internet and no cached script."
	return
end try
