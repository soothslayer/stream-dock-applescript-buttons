-- buttons/Row1-Col5.applescript
-- Thin wrapper: downloads and runs scripts/Row1-Col5.applescript from GitHub.
-- Assign this (compiled as .app) to Stream Deck button at row 1, column 5.
-- To change what this button does, edit scripts/Row1-Col5.applescript in the repo.

set scriptName to "Row1-Col5.applescript"
...
on error
	say "Button " & "1" & " " & "5" & " not available. No internet and no cached script."
	return
end try
