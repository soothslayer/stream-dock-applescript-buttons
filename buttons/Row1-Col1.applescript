-- buttons/Row1-Col1.applescript
-- Thin wrapper: downloads and runs scripts/Row1-Col1.applescript from GitHub.
-- Assign this (compiled as .app) to Stream Deck button at row 1, column 1.
-- To change what this button does, edit scripts/Row1-Col1.applescript in the repo.

set scriptName to "Row1-Col1.applescript"
...
on error
	say "Button " & "1" & " " & "1" & " not available. No internet and no cached script."
	return
end try
