-- buttons/Row3-Col4.applescript
-- Thin wrapper: downloads and runs scripts/Row3-Col4.applescript from GitHub.
-- Assign this (compiled as .app) to Stream Deck button at row 3, column 4.
-- To change what this button does, edit scripts/Row3-Col4.applescript in the repo.

set scriptName to "Row3-Col4.applescript"
...
on error
	say "Button " & "3" & " " & "4" & " not available. No internet and no cached script."
	return
end try
