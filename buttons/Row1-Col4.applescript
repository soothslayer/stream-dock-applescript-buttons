-- buttons/Row1-Col4.applescript
-- Thin wrapper: downloads and runs scripts/Row1-Col4.applescript from GitHub.
-- Assign this (compiled as .app) to Stream Deck button at row 1, column 4.
-- To change what this button does, edit scripts/Row1-Col4.applescript in the repo.

set scriptName to "Row1-Col4.applescript"
...
on error
	say "Button " & "1" & " " & "4" & " not available. No internet and no cached script."
	return
end try
