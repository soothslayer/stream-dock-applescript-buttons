-- buttons/Row2-Col3.applescript
-- Thin wrapper: downloads and runs scripts/Row2-Col3.applescript from GitHub.
-- Assign this (compiled as .app) to Stream Deck button at row 2, column 3.
-- To change what this button does, edit scripts/Row2-Col3.applescript in the repo.

set scriptName to "Row2-Col3.applescript"
...
on error
	say "Button " & "2" & " " & "3" & " not available. No internet and no cached script."
	return
end try
