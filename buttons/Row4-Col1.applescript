-- buttons/Row4-Col1.applescript
-- Thin wrapper: downloads and runs scripts/Row4-Col1.applescript from GitHub.
-- Assign this (compiled as .app) to Stream Deck button at row 4, column 1.
-- To change what this button does, edit scripts/Row4-Col1.applescript in the repo.

set scriptName to "Row4-Col1.applescript"
...
on error
	say "Button " & "4" & " " & "1" & " not available. No internet and no cached script."
	return
end try
